// Simple style-system helper to expand shorthand props into inline styles

export function expandStyleProps(props = {}) {
  const s = {};
  const set = (k, v) => { if (v !== undefined && v !== null) s[k] = v; };
  ...
  if (backdropBlur !== undefined && backdropBlur !== null) set('backdropFilter', `blur(${backdropBlur})`);
